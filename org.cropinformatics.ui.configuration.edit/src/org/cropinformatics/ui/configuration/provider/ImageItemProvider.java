...
/**
 * This is the item provider adapter for a {@link org.cropinformatics.ui.configuration.Image} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConfigurationPackage.Literals.IMAGE__PATH,
				 true,
				 false,
				 false,
	...
	protected void addKeyPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Image_key_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Image_key_feature", "_UI_Image_type"),
				 ConfigurationPackage.Literals.IMAGE__KEY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPluginIdPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Image_pluginId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Image_pluginId_feature", "_UI_Image_type"),
				 ConfigurationPackage.Literals.IMAGE__PLUGIN_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
