...
/**
 * This is the item provider adapter for a {@link org.cropinformatics.ui.configuration.ConfigurationListType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationListTypeItemProvider
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public ConfigurationListTypeItemProvider(AdapterFactory adapterFactory)
	{
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(ConfigurationPackage.Literals.CONFIGURATION_LIST_TYPE__CONFIGURATION);
		}
	...
	/**
	 * This returns ConfigurationListType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConfigurationListType"));
	}
	...
	{
		return getString("_UI_ConfigurationListType_type");
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(ConfigurationListType.class))
		{
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.CONFIGURATION_LIST_TYPE__CONFIGURATION,
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.CONFIGURATION_LIST_TYPE__CONFIGURATION,
				 ConfigurationFactory.eINSTANCE.createDialogConfiguration()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.CONFIGURATION_LIST_TYPE__CONFIGURATION,
				 ConfigurationFactory.eINSTANCE.createPartConfiguration()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.CONFIGURATION_LIST_TYPE__CONFIGURATION,
				 ConfigurationFactory.eINSTANCE.createEditorConfiguration()));
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.CONFIGURATION_LIST_TYPE__CONFIGURATION,
				 ConfigurationFactory.eINSTANCE.createPerspectiveConfiguration()));
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.CONFIGURATION_LIST_TYPE__CONFIGURATION,
				 ConfigurationFactory.eINSTANCE.createViewConfiguration()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.CONFIGURATION_LIST_TYPE__CONFIGURATION,
				 ConfigurationFactory.eINSTANCE.createWizardConfiguration()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.CONFIGURATION_LIST_TYPE__CONFIGURATION,
				 ConfigurationFactory.eINSTANCE.createWizardPageConfiguration()));
	}
