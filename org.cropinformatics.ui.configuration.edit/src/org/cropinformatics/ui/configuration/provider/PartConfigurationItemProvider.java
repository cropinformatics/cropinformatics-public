...
/**
 * This is the item provider adapter for a {@link org.cropinformatics.ui.configuration.PartConfiguration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PartConfigurationItemProvider
		...
		IItemPropertySource
{
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(ConfigurationPackage.Literals.PART_CONFIGURATION__CONTROL);
		}
	...
	/**
	 * This returns PartConfiguration.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PartConfiguration"));
	}
	...
	{
		String label = ((PartConfiguration)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PartConfiguration_type") :
			getString("_UI_PartConfiguration_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.PART_CONFIGURATION__CONTROL,
