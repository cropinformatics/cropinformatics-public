...
public class SingleListTableDialog<T extends Object> extends AbstractListDialog<T>
{
   ...
   */
  public SingleListTableDialog(Shell parentShell, DialogConfiguration configuration, String title)
  {
   ...
   */
  public SingleListTableDialog(Shell parentShell, DialogConfiguration configuration, String title, String message)
  {
   ...
   */
  public SingleListTableDialog(Shell parentShell, DialogConfiguration configuration, String title, String message, List<T> items)
  {
   ...
   */
  public SingleListTableDialog(Shell parentShell, DialogConfiguration configuration, String title, String message, List<T> items, List<T> selectedItems)
  {
  ...
  {
		SingleListTableViewer<T> listViewer = new SingleListTableViewer<T>(parent, configuration, items, selectedItems);
