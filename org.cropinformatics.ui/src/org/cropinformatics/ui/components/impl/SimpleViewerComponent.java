...
public class SimpleViewerComponent<T extends Viewer> extends ViewerComponent<ControlConfiguration, T>
{
  public SimpleViewerComponent(T control, ControlConfiguration configuration)
  {
