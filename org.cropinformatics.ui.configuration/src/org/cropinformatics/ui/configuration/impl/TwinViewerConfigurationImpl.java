 ...
 * <ul>
 *   <li>{@link org.cropinformatics.ui.configuration.impl.TwinViewerConfigurationImpl#isItemAddedLeftToRight <em>Item Added Left To Right</em>}</li>
 *   <li>{@link org.cropinformatics.ui.configuration.impl.TwinViewerConfigurationImpl#isItemAddedRightToLeft <em>Item Added Right To Left</em>}</li>
 *   <li>{@link org.cropinformatics.ui.configuration.impl.TwinViewerConfigurationImpl#isItemRemovedLeftToRight <em>Item Removed Left To Right</em>}</li>
 *   <li>{@link org.cropinformatics.ui.configuration.impl.TwinViewerConfigurationImpl#isItemRemovedRightToLeft <em>Item Removed Right To Left</em>}</li>
 *   <li>{@link org.cropinformatics.ui.configuration.impl.TwinViewerConfigurationImpl#isDuplicateAllowed <em>Duplicate Allowed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
