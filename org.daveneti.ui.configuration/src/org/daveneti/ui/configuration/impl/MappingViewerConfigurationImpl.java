 ...
 * <ul>
 *   <li>{@link org.daveneti.ui.configuration.impl.MappingViewerConfigurationImpl#isFromItemRemovedWhenMapped <em>From Item Removed When Mapped</em>}</li>
 *   <li>{@link org.daveneti.ui.configuration.impl.MappingViewerConfigurationImpl#isFromItemAddedWhenUnmapped <em>From Item Added When Unmapped</em>}</li>
 *   <li>{@link org.daveneti.ui.configuration.impl.MappingViewerConfigurationImpl#isToItemRemovedWhenMapped <em>To Item Removed When Mapped</em>}</li>
 *   <li>{@link org.daveneti.ui.configuration.impl.MappingViewerConfigurationImpl#isToItemAddedWhenUnmapped <em>To Item Added When Unmapped</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
