 ...
 * <ul>
 *   <li>{@link org.daveneti.ui.configuration.impl.ListViewerConfigurationImpl#isMultipleSelectionInUse <em>Multiple Selection In Use</em>}</li>
 *   <li>{@link org.daveneti.ui.configuration.impl.ListViewerConfigurationImpl#isMultipleCheckInUse <em>Multiple Check In Use</em>}</li>
 *   <li>{@link org.daveneti.ui.configuration.impl.ListViewerConfigurationImpl#isDuplicateAllowed <em>Duplicate Allowed</em>}</li>
 *   <li>{@link org.daveneti.ui.configuration.impl.ListViewerConfigurationImpl#isCheckSelectionInUse <em>Check Selection In Use</em>}</li>
 *   <li>{@link org.daveneti.ui.configuration.impl.ListViewerConfigurationImpl#isThreadingInUse <em>Threading In Use</em>}</li>
 *   <li>{@link org.daveneti.ui.configuration.impl.ListViewerConfigurationImpl#isCopyItemsInUse <em>Copy Items In Use</em>}</li>
 *   <li>{@link org.daveneti.ui.configuration.impl.ListViewerConfigurationImpl#isVirtualInUse <em>Virtual In Use</em>}</li>
 *   <li>{@link org.daveneti.ui.configuration.impl.ListViewerConfigurationImpl#isMantainingSelectionState <em>Mantaining Selection State</em>}</li>
 *   <li>{@link org.daveneti.ui.configuration.impl.ListViewerConfigurationImpl#isMantainingCheckedState <em>Mantaining Checked State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
