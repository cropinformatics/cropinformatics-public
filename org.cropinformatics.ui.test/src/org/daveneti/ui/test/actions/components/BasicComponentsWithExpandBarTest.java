 ...
 */
public class BasicComponentsWithExpandBarTest extends BaseWorkbenchWindowActionDelegate
{
  public BasicComponentsWithExpandBarTest()
  {
  }
  ...
  public void run(IAction action)
  {
    BasicComponentsDialog basicComponentsDialog = 
      new BasicComponentsDialog(getWindow().getShell(), ConfigurationUtils.getDialogConfiguration(BasicComponentsDialog.class.getName()+"WithExpandBar"), 
