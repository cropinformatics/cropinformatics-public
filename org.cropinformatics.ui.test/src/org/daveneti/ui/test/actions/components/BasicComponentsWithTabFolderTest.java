 ...
 */
public class BasicComponentsWithTabFolderTest extends BaseWorkbenchWindowActionDelegate
{
  public BasicComponentsWithTabFolderTest()
  {
  }
  ...
  public void run(IAction action)
  {
    BasicComponentsDialog basicComponentsDialog = 
      new BasicComponentsDialog(getWindow().getShell(), ConfigurationUtils.getDialogConfiguration(BasicComponentsDialog.class.getName()+"WithTabFolder"), 
